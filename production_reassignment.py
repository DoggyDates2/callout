...
# ============================================================================
# GitHub Actions Workflow File + Google Apps Script Trigger
# Save as .github/workflows/dog-reassignment.yml
# ============================================================================
...
# Add this to Google Apps Script (script.google.com)
# ============================================================================
...
# ============================================================================
# Setup Instructions for M1 Trigger
# ============================================================================

"""
SETUP STEPS:

1. **UPDATE COLUMN HEADERS** in your code:
   - Tell me your exact column headers so I can fix the mapping
   - Current assumption: A=Dog ID, G=Name, I=Group Assignment
...
3. **SETUP GOOGLE APPS SCRIPT**:
   ...
   - Create new project  
   - Replace Code.gs with the script above
   - Update CONFIG with your GitHub and Sheets info
   - Save the project

4. **ADD GITHUB SECRET**:
   - Add GITHUB_TOKEN to your repository secrets
   - Update CONFIG.GITHUB_TOKEN to use PropertiesService instead:
...
6. **TEST**:
   - Change M1 cell in your Google Sheet
   - Check GitHub Actions tab to see if workflow triggered
   - Check Apps Script logs for debugging

BENEFITS:
🎯 Triggers ONLY when M1 changes (not on schedule)
⚡ Instant response (within seconds of M1 change)
🔄 Passes M1 value to Python script for conditional logic
📱 Optional: Shows toast notification in Google Sheets
🔍 Full logging for debugging
"""

# ============================================================================
# Setup Instructions - COPY YOUR EXACT GOOGLE SHEETS CONFIGURATION
# ============================================================================

"""
SETUP CHECKLIST:

✅ 1. UPDATE GOOGLE SHEETS URLS IN CODE:
   - DISTANCE_MATRIX_URL: Your Matrix Matrix 2.csv export URL
   - MAP_SHEET_URL: Your New districts Map 8.csv export URL  
   - DRIVER_SHEET_URL: Your New districts Driver Counts 3.csv export URL
   - MAP_SPREADSHEET_ID: Your map spreadsheet ID for writing results

✅ 2. CREATE GITHUB REPOSITORY:
   - Create new repo or use existing
   - Add production_reassignment.py to root
   - Add .github/workflows/dog-reassignment.yml

✅ 3. SETUP GOOGLE SERVICE ACCOUNT:
   - Google Cloud Console → Enable Sheets API
   - Create Service Account → Download JSON key
   - Share ALL your Google Sheets with service account email (Editor permission)
...
✅ 5. TEST FIRST:
   ...
   - Check Actions tab for logs and results
   - Verify results appear in your Google Sheets

✅ 6. YOUR EXACT LOGIC IS PRESERVED:
   - All your distance matrix loading logic ✅
   - All your group parsing (including 2XX2 → 2) ✅
   - All your proximity-based reassignment ✅
   - All your capacity checking ✅  
   - All your iterative reassignment with domino effects ✅
   - All your priority system ✅

BENEFITS OF THIS SETUP:
🚀 Runs automatically every weekday at 6 AM
⚡ Processes in 5-10 seconds vs 30-60 seconds in Streamlit
📊 Updates your Google Sheets directly
📧 Only sends notifications when reassignments happen
