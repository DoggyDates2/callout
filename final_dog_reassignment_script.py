...
def load_google_sheet_data():
    ...
    try:
        # Distance Matrix - using correct spreadsheet ID with Matrix tab (gid=0)
        ...
        # Map Data - using correct spreadsheet ID with Map tab (gid=0) 
        ...
        # Driver Counts (this one already works!)
